...
from src.models.clinical_xgb_with_labs import build_xgb_model, prepare_xgb_matrix
...
def main() -> None:
    ...
    parser.add_argument(
        "--output-dir",
        type=str,
        default="artifacts/models/clinical_xgb_with_labs_u_ignore_hadm_only_temporal",
    )
    ...
    X_train = prepare_xgb_matrix(train_df)
    y_train = train_df["target"].astype(int)

    X_val = prepare_xgb_matrix(val_df)
    X_test = prepare_xgb_matrix(test_df)
